...
accordion-new:
  ...
  - title: I am a coffee shop/hawker centre/food court operator. Do I need to enable TraceTogether-only SafeEntry?
    content: |
  ...
  - title: Do I need to apply for an exemption to resume operations for Phase Two?
    content: |
      ...
      However, please note that you will need to submit manpower details via the GoBusiness portal within two weeks from 19 June 2020.  

accordion-a:
  - title: What are the safe management measures F&B establishments need to implement for dine-in?
    content: |
      With effect from 19 June 2020, dine-in for F&B establishments is allowed. Please refer to the [advisory for Re-opening of Food & Beverage Establishments](/safemanagement/sector/) for details on the applicable safe management measures.

  - title: Can F&B establishments use acrylic dividers or physical barriers to replace the need for 1m safe distancing?
    content: |        
  ...
  - title: What are the visible symptoms to check for and how should I check this?
    content: |  
  ...
  - title: Are we allowed to hold sales and promotional activities within our F&B outlets?
    content: |  
  ...
  - title: Are there guidelines for diners on when they can remove their mask and how soon would they need to put it back on?
    content: |   
  ...
  - title: Can F&B establishments serve alcohol? If so, can the bar counters in the restaurants be opened?
    content: |  
  ...
  - title: Can F&B establishments without a retail licence serve alcohol for takeaway or delivery?
    content: |  
      ...
      F&B outlets may make the application online at GoBusiness website. Please note that the application is subject to the planning permission for the premises permitting takeaway or deliveries, among other considerations. In the interim when such an application (if any) was submitted and is being processed, Police will continue to exercise flexibility until the outcome of the licence application is made known to the applicant.

      Should you require further information or assistance on the matter, please contact SPF [here](SPF_PLRD_PELLD@spf.gov.sg){:target="_blank"}.

  - title: Why is there a limit of 60 decibels set for the volume of the background music played in my F&B establishment? What is the basis of this?
    content: |  
  ...
  - title: I am a licensed food caterer and understand that self-service buffet lines are not allowed currently. Am I allowed to provide food catering services at a funeral related event such as wake, where the food is handled and served by my staff, or that it is individually packed for the attendees?
    content: |
  ...
  - title: Can meals be catered or consumed at funeral services?
    content: |
...
accordion-c:
  ...
  - title: With more shops opening, crowds are coming back. How else can I better control the crowd level in my store?
    content: |  
      ...
      You may also wish to adopt [queue management systems](https://www.smeportal.sg/content/tech-depot/en/psg/generic-it-solution-category/visitor-management-queue-management-system.html){:target="_blank"}, which are supported under the [Productivity Solutions Grant](https://www.enterprisesg.gov.sg/financial-assistance/grants/for-local-companies/productivity-solutions-grant){:target="_blank"}.

  - title: Are in-store and mall promotions e.g. sales and special offers allowed?
    content: |
  ...
  - title: Are in-store events and activities or mall atrium activities allowed?
    content: |
      Activities and events at mall atriums must not be held.    

  - title: When will we know if atrium sales can resume?
    content: |
      Atrium sales are not permitted until further notice.

  - title: What are the visible symptoms to check for and how should I check this? As a mall operator, can I turn away all customers who appear unwell?
    content: |
      Notable visible symptoms to look out for include: (a) coughing; (b) sneezing; (c) breathlessness; and (d) a runny nose.
  ...
  - title: Will malls be held accountable if their tenants do not comply with the safe management measures?
    content: |
  ...
  - title: Do retailers need to apply for permission if they intend to organise in-store or mall promotions e.g. sales and special offers? What guidelines do they have to follow when organising such activities?
    content: |
  ...
  - title: For retailers who have to cross-deploy their staff, what are the additional safeguards that they have to put in place to minimise the risk of cross infection?
    content: |
  ...
  - title: Are testers and samples allowed?
    content: |
  ...
  - title: Can communal water-based facilities such as showers/spas/saunas/jacuzzi facilities be used?
    content: |
  ...
  - title: As an operator of make-up or facial therapy services, what additional precautions should I take for my employees, as my customers are unable to wear a face mask during these services?
    content: |
  ...
  - title: Do customers need to wear a face mask for facial hair grooming/facial threading services?
    content: |     
  ...
  - title: Are paid kiddy rides/indoor playgrounds/family entertainment centres permitted to resume operations?
    content: |   
      ...
      More details can be found [here](/safemanagement/sector/).

  - title: Are common play areas for children in F&B/retail shops/malls allowed to open?
    content: |         
  ...
  - title: Are indoor kids’ playgrounds and leisure centres in malls allowed to open?
    content: |   
  ...
  - title: Are game arcades/claw machines permitted to resume operations?
    content: |   
  ...
  - title: Are vending machines permitted to open?
    content: |   
      Yes, vending machines are permitted to open.

  - title: Are retail businesses who conduct their businesses from their outdoor display areas outside their retail shops permitted to resume operations?
    content: |   
      ...
      Retailers are required to implement safe management measures. More details can be found [here](/safemanagement/sector/).

  - title: Are home-based beauty salons allowed to reopen? Is there an advisory for home-based beauty salon businesses?
    content: |   
      ...
      Before resuming activities, businesses must comply with the requirements for [Safe Management Measures](/safemanagement/general/) and any sector-specific requirements which apply to them. For retail and lifestyle-related services, which include beauty services, businesses may refer to the [joint advisories](https://www.enterprisesg.gov.sg/covid-19/safe-distance){:target="_blank"} issued by ESG, STB, SFA, HDB and URA.

  - title: Are there guidelines for saunas, especially large-format spas and saunas?
    content: |   
  ...
  - title: Should malls continue to demarcate lifts with one-metre spacing?
    content: |
      ...
      In lieu of the 1-metre safe distancing requirements in lift, lift owners should implement the following safe management measures found [here](https://www1.bca.gov.sg/docs/default-source/bca-restart/advisory-to-lift-owners-smm-lifts.pdf){:target="_blank"}.

  - title: Are kiosks and push-carts permitted to resume operations?
    content: |
  ...
  - title: Are unmanned massage chairs in malls allowed to operate?
    content: |
  ...
  - title: Can shoppers remove their masks and sit at common areas to consume takeaway food?
    content: |       
  ...
  - title: For retail stores that are currently under renovation and are taking up a temporary lease at atrium space, can they operate?
    content: |     
      Yes, they can do so, but subject to ESG’s approval. They may write to <retail_design@enterprisesg.gov.sg>.

  - title: The main walkway to office block passes through some retail units (facing corridor), do workers still need to do SafeEntry and temperature checks?
    content: |    
  ...
  - title: Can designated smoking areas (DSAs) be reopened?
    content: |  
      Yes, malls may reopen DSAs, so long as the safe distancing measures are adhered to. Malls can refer to the [latest NEA advisory for the guidelines on DSAs](https://www.nea.gov.sg/our-services/public-cleanliness/environmental-cleaning-guidelines/post-circuit-breaker-measures){:target="_blank"}.  
