...
<span style="font-weight: bold; font-family: hknova-bold;">Please use desktop / laptop to apply for this licence.</span><br>
<span>You can only view application details and make payment via mobile. Please use GoBusiness Licensing on desktop to use all features.</span><br>
<a id="mobileNotice" href="/browse-all-licences/Animal-&-Veterinary-Service-(AVS)/Certificate-of-Freedom-From-Disease-Within-Singapore" target="_blank" rel="noopener">Continue to GoBusiness Licencing anyway</a>
</div>
