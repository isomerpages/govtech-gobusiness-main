...
const custom_notifications = [
  ...
  "<b>[Attention: System Maintenance]</b> Starting-a-Business Service Journey will be unavailable due to scheduled maintenance from 10 July to 31 July 2024 6pm.",
  "<b>[Attention: System Maintenance]</b> All transactions for some IMDA licences will be unavailable due to urgent maintenance from 16 July 2024, 11:00am to 5:00pm.<br>- Localised Private Network Licence<br>- General Radio-comm (Mobile Station)<br>- General Radio-comm Station (Base or Fixed Station)<br>- General Radio-comm Station (Fixed Link or Relay Station)<br>- General Radio-comm Station (Radiodetermination Station)."
];
