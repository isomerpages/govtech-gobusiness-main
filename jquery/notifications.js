...
const custom_notifications = [
  ...
  "<b>[Attention: Important Announcement] Application for AMENDMENT of Newspaper Permit and Printing Press Licence under the Infocomm Media Development Authority (IMDA) is under maintenance and is unavailable. In the meantime, please send your amendment requests to: Registry_of_Newspapers@mddi.gov.sg.",
