...
const custom_notifications = [
  ...
  "<b>[Attention: System Maintenance] GoBusiness Website (including Pre-login, Dashboard and all licensing functions)</b> will be unavailable on 6th Oct 2025 6pm to 8pm.<br>Draft forms (including applications, amendment, renewal & cancellation) of the following NEA’s licences* will be affected and will be removed after the scheduled maintenance. Forms which are submitted before the scheduled maintenance will not be affected and can be viewed in GoBusiness Dashboard.<br>*Cleaning Business Licence, Environmental Control Coordinator Certificate of Registration, Environmental Control Officers (for Specified Premises, Specified Construction Sites) Certificate of Registration, Fumigation Licence, Fumigation Permit, Vector Control Operator Certificate, Vector Control Technician Licence, and Vector Control Worker Certificate."
];
