...
const custom_notifications = [
  ...
  "<b>[Attention: Important Notice]</b> Please be informed that the GoBusiness Licensing Helpdesk will operate from <B><U>8:00 AM to 2:00 PM</B></U> on the following festival eves:<br>
