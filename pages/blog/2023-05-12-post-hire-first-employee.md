...
There are stiff penalties for foreigners who work without the relevant work passes, so do make sure that all passes and permits are approved by MOM before you hire any foreign employees.
...
![Job Interview](/images/blog/content/HiringFirstEmployee 2.png)
...
Picking the right person for any job is never an easy task. Focus on finding the right member for your team. Apart from reviewing resumes or job application forms for qualifications, skills, knowledge, and the experience required for the job, you should take note of character references and testimonials from previous employers as well, to make sure that your new employee possesses a good attitude and the soft skills needed to be a trustworthy team-member you can count on.
...
The interview stage went smoothly and you’ve found your suitable candidate! The next step would then be to negotiate the Key Employment Terms (KETs) and send the candidate an offer letter.
...
You can find this [list of work injury compensation designated insurers](https://www.mom.gov.sg/-/media/mom/documents/safety-health/lists/designated-insurers.pdf){:target="_blank"}{:rel="noopener"} on the Ministry of Manpower website.
...
Some positions will require more training than others if you would like to help your employee progress their careers in the long run. But have no fear, because we have plenty of options for employers who want to help their employees upskill.
...
Visit the [GoBusiness website](/start-a-business/hire-employees/?src=gobiz_blog){:target="_blank"}{:rel="noopener"} to learn more about your duties as a new employer.
