...
<li><strong>How soon can my application be processed?</strong><br>A complete application will be processed within seven (7) working days, subject to the submission of all supporting documents and required information. Any omission or incorrect information furnished may require further clarification with the applicant resulting in a delay in the processing time.<br><br></li>
