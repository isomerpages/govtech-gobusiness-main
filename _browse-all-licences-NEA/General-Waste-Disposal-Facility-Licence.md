...
<li><strong>How soon can my application be processed?</strong><br>We will process your application within 30 working days from the date we receive the full set of documents for evaluation. Complex applications, such as cases requiring inspections, may require additional processing time.<br><br></li>
