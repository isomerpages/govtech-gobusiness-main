...
<ol>
<li>
<p><strong>What requirements/documents do I need before I submit my application online?<br></strong>To register as a Vector Control Operator, companies must fulfil the following requirements:<br>i. Register with ACRA<br>ii. (For NEW registering companies) Employ* at least one dedicated full Vector Control Technician with at least 3 years of experience in vector control works.</p>
...
<p><strong>Related licence(s)</strong><br>NEA <a href="https://dashboard.gobusiness.gov.sg/task-details/vectorcontroltechnicianlicence" target="_blank" rel="noopener">Vector Control Technician Licence</a><br>NEA <a href="https://dashboard.gobusiness.gov.sg/task-details/vectorcontrolworkercertificate" target="_blank" rel="noopener">Vector Control Worker Certificate</a></p>
